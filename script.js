...
const subsBtn = document.querySelector('[data-subscribe]');
const unsubsBtn = document.querySelector('[data-unsubscribe]');
...
subsBtn.addEventListener('click', () => {
  ...
  if (localStorage.checker) {
    ...
    symbolPop.innerHTML = "✓";
    symbolPop.style.color = "#2ecc71";
    paraPop.innerHTML = "Thank you for subscribing our platform!";
    unsubsBtn.style.display = "block";
...
unsubsBtn.addEventListener('click', () => {
  popupCon.setAttribute('data-popup-con', 'true');
  popupBox.setAttribute('data-popup', 'true');
  symbolPop.innerHTML = "✓";
  symbolPop.style.color = "#2ecc71";
  paraPop.innerHTML = "Unsubscribing complete!";
  unsubsBtn.style.display = "none";
